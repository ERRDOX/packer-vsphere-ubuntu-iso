...
# # Install docker
# apt update -y
# apt install -y wget git vim bash-completion curl htop iftop jq ncdu unzip net-tools dnsutils \
#                atop sudo ntp fail2ban software-properties-common apache2-utils tcpdump telnet
